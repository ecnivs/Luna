...
This file contains all configurable settings for Luna, including
...
# -------------------------------
PROMPT = """
Expect Cybersecurity focused queries.
Always keep it short unless explicitly asked.
...
Stay concise, get right to the point and keep it short.
